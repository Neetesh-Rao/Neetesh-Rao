...
<!-- ANIMATED BANNER -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=200&section=header&text=Neetesh%20Kumar&fontSize=60&fontColor=ffffff&fontAlignY=38&desc=Full%20Stack%20Developer%20%7C%20AI%20Engineer%20%7C%20Builder&descAlignY=58&descSize=18&animation=fadeIn" width="100%"/>

<!-- TYPING SVG -->
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&pause=1000&color=7C3AED&center=true&vCenter=true&width=600&lines=Building+Production-Grade+Web+Apps;MERN+Stack+%7C+Next.js+%7C+TypeScript;LLM+Integration+%7C+AI+Agents+%7C+RAG;Open+Source+Contributor;From+Greater+Noida%2C+India+%F0%9F%87%AE%F0%9F%87%B3" alt="Typing SVG" />
...
const neetesh = {
  ...
  focus     : ["MERN Stack", "Next.js", "LLM Integration", "AI Agents"],
  status    : "Open to Freelance & Full-Time Opportunities 🚀",
  building  : "Production apps that scale — fast, clean, intelligent",
};
```
...
![RAG](https://img.shields.io/badge/RAG_Pipeline-7C3AED?style=for-the-badge&logo=databricks&logoColor=white)
...
<div align="center">
<img src="https://github-readme-streak-stats.herokuapp.com?user=YOUR_GITHUB_USERNAME&theme=tokyonight&border=7c3aed&background=0d1117&stroke=7c3aed&ring=7c3aed&fire=ff6b6b&currStreakLabel=c9d1d9&sideLabels=c9d1d9&dates=8b949e&currStreakNum=ffffff&sideNums=ffffff" alt="GitHub Streak"/>
</div>
...
|--------|-------|-------------|
| 🏗️ **WorkMesh CRM** | Node.js · MongoDB · WhatsApp API | AI-powered CRM for unorganized Indian SMBs with WhatsApp task ingestion |
| 🎓 **School ERP SaaS** | Node.js · Express · React | Multi-campus ERP for 11,000+ students — fees, hostel, attendance, AI dedup |
| 🌐 **Crowdfunding Platform** | MERN Stack · JWT | End-to-end fundraising platform with payment flow |
| 🤖 **AI Workflow Agent** | n8n · Ollama · LangChain | Local Jarvis-style AI agent with zero-cost LLM orchestration |
| 🏨 **Hotel Reservation System** | Node.js · PostgreSQL · Prisma | Full-featured booking backend with real-time availability |
